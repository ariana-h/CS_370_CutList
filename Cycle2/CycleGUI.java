...
public class CycleGUI extends JFrame{
    ...
    //blade width        
        ...
        JLabel bladeLabel = new JLabel("Kerf Thickness"); 
        ...
        //This is the action listener to get the user input for kerf thickness
            ...
            public void actionPerformed(ActionEvent e){
                ...
                if(numSlash == 0) {
                	try {
                		...
                		bladeThicknessLabel.setText("Kerf Thickness: " + bladeThickness);
                		DrawAlg();
                	...
                	numbers = bladeThicknessText.split("/");
                		try {
                			...
                			if(num2 == 0){ 
                				...
                				bladeThicknessLabel.setText("kerf Thickness: " + bladeThicknessText);
                				DrawAlg();
                			}
    ...
    //Global stats
        ...
        bladeThicknessLabel = new JLabel("Kerf Thickness: ");
	...
	public void Canvas(Graphics g){
		 ...
		 for(Wood W : Boards){
		     ...
		     */
			 g2d.setStroke(new BasicStroke(1));
			 g.setColor(Color.black);
			 g.fillRect((int)(0-bladeThickness), 0 + oldY - (int)(bladeThickness),(int)(W.GetWidth() + (2*bladeThickness)),(int)(W.GetHeight()+ (2*bladeThickness))); 
		 ...
		 for(Wood W : Pieces){
			 ...
			 for (Rectangle R : DrawRect){
				 ...
				 if(R.getWidth() > W.GetWidth() && R.getHeight()>W.GetHeight() && !found)
				 {
					 ...
					 //Display Label
					 g.setColor(Color.black);
					 g.setFont(new Font("Helvetica",0,(int)bladeThickness));
					 FontMetrics fontMetrics = g.getFontMetrics(g.getFont());
					 int PW = fontMetrics.stringWidth(W.GetName());
					 g.drawString(W.GetName(), (int)(Name.getCenterX() - (int)(PW/2)), (int)(Name.getCenterY() +(int)(bladeThickness/3)));
